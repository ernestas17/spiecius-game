...
const headlineContainerElement = document.querySelector('.headline-container');
...
// Functions
const startQuiz = () => {
  headlineContainerElement.classList.add('hide');
...
*/
  ...
  if (!this.menu) {
    this.menu = new Menu({
      ...
      idDivMenu: 'divmenu',
      title: 'Pasirinkite lygį',
      lineOffset: 37,
      lineStep: 37,
      lines: [
        { text: 'Labai lengvas: 12 detalių', func: this.returnFunct(12) },
        { text: 'Lengvas: 25 detalės', func: this.returnFunct(25) },
        { text: 'Vidutinis: 50 detalių', func: this.returnFunct(50) },
        { text: 'Sunkus: 100 detalių', func: this.returnFunct(100) },
        { text: 'Labai sunkus: 200 detalių', func: this.returnFunct(200) },
      ],
    });
  }
  if (autoStart) {
...
window.addEventListener('load', function () {
  let img = '../assets/games/delione/map.png';

  autoStart = isMiniature(); // used for nice miniature in CodePen

  const width = window.innerWidth > 1400 ? 1370 : window.innerWidth;
  const height =
